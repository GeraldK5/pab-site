...
const Header: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 z-50 w-full bg-white dark:bg-dark shadow-sm">
        ...
        <div className="container mx-auto lg:max-w-7xl px-4 py-1.5">
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <svg viewBox="0 0 16 16" className="hidden h-4 w-4 dark:block">
                ...
                <svg viewBox="0 0 23 23" className="h-4 w-4 dark:hidden">
      ...
      {/* Main Navigation */}
      <div className="bg-white dark:bg-dark border-b border-border dark:border-dark_border">
